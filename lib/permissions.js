...
export const PERMISSION_GROUPS = {
  ...
  Sewadars: [
    { key: 'sewadars:view', label: 'View Volunteers' },
    { key: 'sewadars:register', label: 'Register Volunteer' },
    { key: 'sewadars:edit', label: 'Edit Volunteer' },
    { key: 'sewadars:mark_attendance', label: 'Mark Attendance' },
    { key: 'sewadars:edit_attendance', label: 'Edit Attendance' },
  ...
  'Golden Members': [
    ...
    { key: 'golden_members:edit', label: 'Edit Golden Member' },
  ],
}
...
const ROUTE_PERMISSIONS = {
  ...
  '/dashboard/volunteers': 'sewadars:view',
